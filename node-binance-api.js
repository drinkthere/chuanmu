...
let api = function Binance( options = {} ) {
    ...
    let fapiBase = 'https://fapi.binance.com/';
   ...
   */
    ...
    return {
        ...
        */
        ...
        futuresOpenInterestHist: async ( symbol, period = "1h", limit = 2) => {
            return promiseRequest( 'futures/data/openInterestHist', { symbol, period, limit }, { base:fapiBase } );
        },
